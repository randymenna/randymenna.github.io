        ...
        children: [
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: './catalogs/catalogs-page.module#CatalogsPageModule'
                    },
                    {
                        path: 'items',
                    ...
                    {
                        path: 'editItem',
                        loadChildren: './edit-item/edit-item-page.module#EditItemPageModule'
                    },
                    {
                        path: 'newCatalog',
                        loadChildren: './new-catalog/new-catalog-page.module#NewCatalogPageModule'
                    }
                ]
            },
            {
